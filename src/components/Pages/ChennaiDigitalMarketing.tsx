...
export const ChennaiDigitalMarketing: React.FC = () => {
  const benefits = [
    "Proven ROI improvement of 360%+ for Chennai businesses",
    "Local Chennai market expertise and cultural insights",
    "24/7 AI-powered automation systems",
    "Dedicated Chennai-based account management",
    "Real-time performance tracking and analytics",
    "Industry-specific strategies for Chennai market"
  ];

  const stats = [
    { icon: <MapPin className="w-6 h-6" />, label: "Chennai Presence", value: "5+ Years" },
    { icon: <Users className="w-6 h-6" />, label: "Chennai Clients", value: "350+" },
    { icon: <TrendingUp className="w-6 h-6" />, label: "Average ROI", value: "360%" },
  ...
  const services = [
    {
      ...
      description: "Dominate Chennai search results with our proven SEO strategies",
      link: "/seo-services-chennai/"
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "PPC Management Chennai",
      description: "Maximize ROI with expert Google Ads management in Chennai",
      link: "/ppc-management-chennai/"
    },
    {
      icon: <Share2 className="w-8 h-8" />,
      title: "Social Media Marketing Chennai",
      description: "Build brand presence across all social platforms in Chennai",
      link: "/social-media-marketing-chennai/"
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Website Development Chennai",
      description: "Professional website design and development for Chennai businesses",
      link: "/website-development-chennai/"
    }
  ];
            ...
            <ScrollReveal direction="up">
              <div className="text-center mb-12">
                ...
                >
                  ...
                  <span className="text-white text-sm">Chennai Digital Marketing Agency</span>
                </motion.div>
                ...
                <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                  Transform your Chennai business with our comprehensive digital marketing solutions. 
                  Expert SEO, PPC, social media marketing, and web development services delivering 
                  proven results for businesses across the Detroit of India.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                  Comprehensive Digital Marketing Services in Chennai
                </h2>
                <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                  From SEO to social media marketing, we provide complete digital solutions for Chennai businesses
                </p>
              </div>
            </ScrollReveal>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                    Why Choose Our Digital Marketing Agency in Chennai?
                  </h2>
                  <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                    Our Chennai-based team understands the local automotive and manufacturing industry dynamics 
                    to deliver targeted digital strategies for South India's business hub.
                  </p>
                ...
                <GlassmorphismCard className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-300">chennai@goddigitalmarketing.com</span>
                    </div>
                    <div className="flex items-center space-x-3">
                  ...
                  <motion.button
                    className="w-full mt-6 px-6 py-3 bg-gradient-to-r from-red-500 to-orange-500 text-white font-bold rounded-lg hover:from-red-600 hover:to-orange-600 transition-all duration-300"
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            <ScrollReveal direction="up">
              ...
              <p className="text-gray-300 text-lg mb-8">
                Join hundreds of successful Chennai businesses that trust God Digital Marketing 
                for their digital growth needs.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.button
                  className="px-8 py-4 bg-gradient-to-r from-red-500 to-orange-500 text-white font-bold rounded-lg hover:from-red-600 hover:to-orange-600 transition-all duration-300"
