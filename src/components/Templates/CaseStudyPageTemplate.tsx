...
import { Target, Briefcase, TrendingUp, Star, MessageSquare, Link as LinkIcon, CalendarDays, Tool, Users } from 'lucide-react'; // Example icons
...
const MetricDisplay: React.FC<{ metricItem: Metric; highlightImprovement?: boolean }> = ({ metricItem, highlightImprovement }) => (
  <BaseCard variant="glass" className="p-4 text-center flex flex-col justify-between h-full">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-8 md:py-12">
          ...
          <AnimatedSection animationType="fadeInUp" duration={1000} delay={100}>
            <section className="mb-12 md:mb-16">
              ...
              <BaseCard variant="glass" className="p-4 sm:p-6">
                <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed break-words">{caseStudy.beforeState.challengeSummary}</p>
          ...
          <AnimatedSection animationType="fadeInUp" duration={1000} delay={200}>
            <section className="mb-12 md:mb-16">
              ...
              <BaseCard variant="glass" className="p-4 sm:p-6">
                <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed break-words">{caseStudy.transformationProcess.strategySummary}</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  {caseStudy.transformationProcess.toolsUsed && caseStudy.transformationProcess.toolsUsed.length > 0 && (
                    <BaseCard variant="default" className="p-3 sm:p-4 bg-slate-800/50">
                      <h3 className="text-md sm:text-lg font-semibold mb-2 text-gray-100 flex items-center"><Tool className="w-4 h-4 sm:w-5 sm:h-5 mr-2 flex-shrink-0" />Tools & Technologies Leveraged:</h3>
          ...
          <AnimatedSection animationType="fadeInUp" duration={1000} delay={300}>
            <section className="mb-12 md:mb-16">
              ...
              <BaseCard variant="glass" className="p-4 sm:p-6">
                <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed break-words">{caseStudy.afterState.resultsSummary}</p>
          ...
          <AnimatedSection animationType="fadeIn" duration={1000} delay={600}>
            <section className="py-12 md:py-16 text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-white break-words">
                Ready to Achieve Similar Success for Your Business in {location.city}?
              </h2>
